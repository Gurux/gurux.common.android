...
public class TraceEventArgs {
     ...
     */
    private java.util.Date mTimestamp = new java.util.Date(0);
    /**
     * Trace type.
     */
     ...
     * @param data Send or received data.
     */
     ...
     * @param type   Trace type.
     * @param data   Send or received data.
     * @param index  Index where data copy is started.
     * @param length How many bytes are included to data.
     */
     ...
     *
     * @param value Sent or received data.
     */
